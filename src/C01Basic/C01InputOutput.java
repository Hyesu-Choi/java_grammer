...
//        System.out.println(20); // 1)println은 줄바꿈 있는 출력. 20을 출력하고 줄바꿈함. 2)입출력은 모두 문자열로 진행
...
//        int input4 = myScanner.nextInt();  // input3을 단순화. input3의 방법을 추천함
//        System.out.println("입력사항 1 : " + input1);
//        System.out.println("입력사항 2 : " + input2);
//        System.out.println("입력사항 3 : " + input3);
//        System.out.println("입력사항 4 : " + input4);

//        입력2 :BufferedReader : 1)버퍼를 활용하여 더 좋은 성능. 2)InputStreamReader는 바이트 대신 문자단위로 입력을 받음.
...
////        close()는 메모리회수. 외부 입출력장치와 연계된 코드이므로, GC(가비지컬렉터)의 대상이 아님.
//        br.close();
