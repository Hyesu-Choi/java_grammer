...
//            추후 스프링에서는 아래와 같은 "validate메서드 + 직접 만든 어노테이션"이 모두 합해져 있는 이미 만들어진 어노테이션을 사용.
            validate(member);
            memberList.add(member);
        }
    }

    //    특정 변수에 NotEmpty 어노테이션 설정이 있을 경우, 값이 비어있는지를 검사 하는 메서드
    static void validate(Object object) throws IllegalAccessException {
//        리플랙션 기술을 통해 런타임시점에 private 변수라 할지라도 객체 안의 필드값을 꺼내 확인할 수 있음.
